...
import { LoginForm } from '@/containers/AuthForms';

export const metadata: Metadata = {
  title: 'Entrar',
  description: 'Acesse sua conta no Fé Viva',
};
  ...
  return (
    <Box className="relative min-h-screen overflow-hidden bg-neutral-50">
      <Box className="pointer-events-none absolute inset-0" aria-hidden="true">
        ...
        <svg className="absolute bottom-0 right-0 opacity-[0.04]" width="300" height="300" viewBox="0 0 100 100" fill="none">
